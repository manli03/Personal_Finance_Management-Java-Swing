...
public class Login extends javax.swing.JFrame {
    ...
    private void passwordKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_passwordKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            // Trigger the jButton1ActionPerformed method
            jButton1ActionPerformed(new java.awt.event.ActionEvent(
                jButton1, // Source of the action
                java.awt.event.ActionEvent.ACTION_PERFORMED, 
                null // Command (optional, can be null)
            ));
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Login Unsuccessful!! Incorrect username or password");
            }
        } catch (Exception e) {
